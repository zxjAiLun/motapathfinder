var functions_d6ad677b_427a_4623_b50f_a445a3b0ef8a = 
{
	...
	*/
	...
	if (core.hasEquip('I924')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I1700')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I1701')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I1702')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I1703')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I1704')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I1705')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I1706')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I1707')) {
		damage *= 0.6;
	}
	if (core.hasEquip('I925')) {
		damage *= 0.9;
	}
	if (core.hasEquip('I1776')) {
		damage *= 0.9;
	}
	...
	*/
	...
	if (!core.domStyle.isVertical) {
		...
		if (core.hasItem('I474')) { core.drawImage(ctx, 'E.png', 29, 368, 60, 60); } else if (core.hasItem('I1182')) {
			if (core.hasItem('I955')) {

				core.drawImage(ctx, 'heart.png', 12, 363, 100, 50);
			} else
				core.drawImage(ctx, 'heart.png', 12, 370, 100, 50);
		} else if (core.hasItem('I964')) { core.drawImage(ctx, '14.png', 12, 363, 100, 50); } else if (core.hasItem('I963')) { core.drawImage(ctx, '13.png', 12, 363, 100, 50); } else if (core.hasItem('I962')) { core.drawImage(ctx, '12.png', 12, 363, 100, 50); } else if (core.hasItem('I961')) { core.drawImage(ctx, '11.png', 12, 363, 100, 50); } else if (core.hasItem('I960')) { core.drawImage(ctx, '10.png', 12, 363, 100, 50); } else if (core.hasItem('I959')) { core.drawImage(ctx, '9.png', 12, 363, 100, 50); } else if (core.hasItem('I958')) { core.drawImage(ctx, '8.png', 12, 363, 100, 50); } else if (core.hasItem('I957')) { core.drawImage(ctx, '7.png', 12, 363, 100, 50); } else if (core.hasItem('I956')) { core.drawImage(ctx, '6.png', 12, 363, 100, 50); } else if (core.hasItem('I955')) { core.drawImage(ctx, '5.png', 12, 363, 100, 50); } else if (core.hasItem('I954')) { core.drawImage(ctx, '4.png', 12, 370, 100, 50); } else if (core.hasItem('I953')) { core.drawImage(ctx, '3.png', 12, 370, 100, 50); } else if (core.hasItem('I952')) { core.drawImage(ctx, '2.png', 12, 370, 100, 50); } else { core.drawImage(ctx, '1.png', 12, 370, 100, 50); }
		...
		if (core.status.hero.lv >= 37) {
			_fillBoldTextWithFontCheck(core.getLvName(), 64, 118, "#E06BBB");
		}
		if (core.status.hero.lv >= 64) {
			_fillBoldTextWithFontCheck(core.getLvName(), 64, 115, "#F0EA28");
		}
		if (core.status.hero.lv >= 91) {
			_fillBoldTextWithFontCheck(core.getLvName(), 64, 115, "#EA4444");
		}
		...
		if (core.getFlag("newlv", 0) > 0) {
			...
			if (infrealm == 1) {
				{ _fillBoldTextWithFontCheck(('初期'), 64, 105, '#E06BBB'); }
			} else if (infrealm == 2) {
				{ _fillBoldTextWithFontCheck(('中期'), 64, 105, '#E06BBB'); }
			} else if (infrealm == 3) {
				{ _fillBoldTextWithFontCheck(('后期'), 64, 105, '#E06BBB'); }
			} else if (infrealm == 4) {
				{ _fillBoldTextWithFontCheck(('初期'), 64, 105, '#6FAEE4'); }
			} else if (infrealm == 5) {
				{ _fillBoldTextWithFontCheck(('中期'), 64, 105, '#6FAEE4'); }
			} else if (infrealm == 6) {
				{ _fillBoldTextWithFontCheck(('后期'), 64, 105, '#6FAEE4'); }
			}
		}
		...
		core.drawImage(ctx, 'a1.png', 60, 255, 16, 16);
		_fillBoldTextWithFontCheck(core.itemCount('I732'), 82, 268, '#9aedec');
		core.drawImage(ctx, 'a2.png', 94, 255, 16, 16);
		_fillBoldTextWithFontCheck(core.itemCount('I733'), 116, 268, '#FFF0F5');
		core.drawImage(ctx, 'f.png', 26, 280, 16, 16);
		_fillBoldTextWithFontCheck(core.itemCount('centerFly'), 48, 293, '#F4A460');
		core.drawImage(ctx, "lv.png", 60, 280, 16, 16);
		_fillBoldTextWithFontCheck(core.itemCount("greenKey"), 82, 293, 'LightGreen');
		core.drawImage(ctx, "lm.png", 94, 280, 16, 16);
		_fillBoldTextWithFontCheck(core.getFlag('saltygreen', 0), 116, 293, "#4ded42");
		...
		// 绘制难度
		if (core.hasItem('I474')) { core.drawImage(ctx, 'E.png', 128, 92, 56, 56); } else if (core.hasItem('I1182')) {
			if (core.hasItem('I955')) {

				core.drawImage(ctx, 'heart.png', 116, 102, 80, 40);
			} else
				core.drawImage(ctx, 'heart.png', 116, 99, 80, 40);

		} else if (core.hasItem('I964')) { core.drawImage(ctx, '14.png', 116, 102, 80, 40); } else if (core.hasItem('I963')) { core.drawImage(ctx, '13.png', 116, 102, 80, 40); } else if (core.hasItem('I962')) { core.drawImage(ctx, '12.png', 116, 102, 80, 40); } else if (core.hasItem('I961')) { core.drawImage(ctx, '11.png', 116, 102, 80, 40); } else if (core.hasItem('I960')) { core.drawImage(ctx, '10.png', 116, 102, 80, 40); } else if (core.hasItem('I959')) { core.drawImage(ctx, '9.png', 116, 102, 80, 40); } else if (core.hasItem('I958')) { core.drawImage(ctx, '8.png', 116, 102, 80, 40); } else if (core.hasItem('I957')) { core.drawImage(ctx, '7.png', 116, 102, 80, 40); } else if (core.hasItem('I956')) { core.drawImage(ctx, '6.png', 116, 102, 80, 40); } else if (core.hasItem('I955')) { core.drawImage(ctx, '5.png', 116, 102, 80, 40); } else if (core.hasItem('I954')) { core.drawImage(ctx, '4.png', 116, 99, 80, 40); } else if (core.hasItem('I953')) { core.drawImage(ctx, '3.png', 116, 99, 80, 40); } else if (core.hasItem('I952')) { core.drawImage(ctx, '2.png', 116, 99, 80, 40); } else { core.drawImage(ctx, '1.png', 116, 99, 80, 40); }
		...
		if (core.status.hero.lv >= 37) {
			_fillBoldTextWithFontCheck(core.getLvName(), 63, 134, "#E06BBB");
		}
		if (core.status.hero.lv >= 64) {
			_fillBoldTextWithFontCheck(core.getLvName(), 63, 134, "#F0EA28");
		}
		if (core.status.hero.lv >= 91) {
			_fillBoldTextWithFontCheck(core.getLvName(), 63, 134, "#EA4444");
		}
		if (core.status.hero.lv >= 118) {
			_fillBoldTextWithFontCheck(core.getLvName(), 63, 134, "#AEAFAF");
		}
		if (core.status.hero.lv >= 351) {
			_fillBoldTextWithFontCheck(core.getLvName(), 63, 128, "#333333");
		}
		if (core.status.hero.lv >= 411) {
			_fillBoldTextWithFontCheck(core.getLvName(), 64, 128, "#333333");
		}
		if (core.status.hero.lv >= 471) {
		...
		if (core.hasFlag('newlv')) {
			var infrealm = core.getFlag('newlv');
			if (infrealm == 1) {
				{ _fillBoldTextWithFontCheck(('初期'), 63, 119, '#E06BBB'); }
			} else if (infrealm == 2) {
				{ _fillBoldTextWithFontCheck(('中期'), 64, 119, '#E06BBB'); }
			} else if (infrealm == 3) {
				{ _fillBoldTextWithFontCheck(('后期'), 64, 119, '#E06BBB'); }
			} else if (infrealm == 4) {
				{ _fillBoldTextWithFontCheck(('初期'), 64, 119, '#F0EA28'); }
			} else if (infrealm == 5) {
				{ _fillBoldTextWithFontCheck(('中期'), 64, 119, '#F0EA28'); }
			} else if (infrealm == 6) {
				{ _fillBoldTextWithFontCheck(('后期'), 64, 119, '#F0EA28'); }
			}
		}
		...
		core.drawImage(ctx, 'a1.png', 340, 76, 16, 16);
		_fillBoldTextWithFontCheck(core.itemCount('I732'), 365, 90, '#9aedec');
