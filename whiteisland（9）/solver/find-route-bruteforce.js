...
const { buildResourcePocketSearchOptions, parseBooleanFlag, parseOptionalNumber, shouldEnableResourcePocket } = require("./lib/cli-options");
...
async function main() {
  ...
  const record = buildRouteRecord({
    ...
    options: {
      ...
      rank,
      solver: "bruteforce",
      startRoute: startRoutePath ? path.relative(solverRoot, startRoutePath) : null,
      startState: startStatePath ? path.relative(solverRoot, startStatePath) : null,
      expanded: result.expansions,
