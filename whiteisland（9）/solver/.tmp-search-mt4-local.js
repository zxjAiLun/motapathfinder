...
for(let depth=0; depth<=20; depth++){
 ...
 if(goal)break; next.sort((a,b)=>posScore(b)-posScore(a)); frontier=next.slice(0,1200); console.log('depth',depth,'frontier',frontier.length,'best',best.floorId,best.hero.hp,best.hero.loc);
}
