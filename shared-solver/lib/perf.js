...
function createPerfTracker(options) {
  ...
  const stabilizationSubphases = {
    ...
    battleTraversal: 0,
    battleEvaluation: 0,
    battleEstimateKeyBuild: 0,
    battleEstimateCacheLookup: 0,
    battleEstimateCacheHitReturn: 0,
    battleEstimateUncachedCompute: 0,
    battleEstimateCacheStore: 0,
    autoEvent: 0,
    applyStep: 0,
    pickupApply: 0,
    pickupTileLookup: 0,
  ...
  const semanticCounters = {
    ...
    battleEstimateCacheHits: 0,
    battleEstimateCacheMisses: 0,
    battleEstimateStores: 0,
    battleEstimateEvictions: 0,
    ...
    const inclusiveSubsystems = {
      ...
      stabilizeState: {
        ...
        subphases: {
          ...
          battleEstimateKeyBuildMs: Number(stabilizationSubphases.battleEstimateKeyBuild.toFixed(3)),
          battleEstimateCacheLookupMs: Number(stabilizationSubphases.battleEstimateCacheLookup.toFixed(3)),
          battleEstimateCacheHitReturnMs: Number(stabilizationSubphases.battleEstimateCacheHitReturn.toFixed(3)),
          battleEstimateUncachedComputeMs: Number(stabilizationSubphases.battleEstimateUncachedCompute.toFixed(3)),
          battleEstimateCacheStoreMs: Number(stabilizationSubphases.battleEstimateCacheStore.toFixed(3)),
        ...
        counters: {
          ...
          battleEstimateCacheHits: Number(semanticCounters.battleEstimateCacheHits || 0),
          battleEstimateCacheMisses: Number(semanticCounters.battleEstimateCacheMisses || 0),
          battleEstimateStores: Number(semanticCounters.battleEstimateStores || 0),
          battleEstimateEvictions: Number(semanticCounters.battleEstimateEvictions || 0),
