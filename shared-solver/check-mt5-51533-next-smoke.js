 ...
 * TEST GRADE: smoke
 *
 * This check intentionally allows found=false.
 * It only verifies:
 *   - seed route (local generated) can be replayed to the 51533 MT5 state
 *   - milestone spec shape for I894
 *   - a 1-expansion segmented run either finds the target or yields doctor diagnostics
 *
 * It is NOT a closure test. A green result does not mean 51533→I894 is solved.
 * See shared-solver/solver-manifest.json tests["shared-solver/check-mt5-51533-next-smoke.js"].
 */
...
function main() {
  ...
  console.log("check-mt5-51533-next-smoke: ok (grade=smoke; found not required)");
}
