...
const TEST_OVERRIDES = {
  ...
  "shared-solver/check-continuation-slice-contract.js": {
    ...
    "requiresStrictReplay": false,
    "cleanCheckout": true,
    "notes": "PR-5.32a/c bounded continuation slice: K=1 identity, shared K budget, fair-pop-only trigger, deterministic local resource-first view, immutable shared rank snapshots/global comparator invariance, default inherit behavior, and local mode in search-semantics fingerprint; pure synthetic simulator, no tower dependency"
  },
  ...
  "shared-solver/check-auto-pickup-apply-contract.js": {
    ...
    "requiresStrictReplay": false,
    "cleanCheckout": true,
    "notes": "PR-5.22f auto-pickup apply cost decomposition, compiled VM effect cache adversarial parity matrix, MT1 real route gate, and paired A/B qualification"
  },
