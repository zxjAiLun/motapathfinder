...
utils.prototype.formatBigNumber = function (x, digits) {
    ...
    for (var i = 0; i < units.length; ++i) {
        ...
        // var u = (x / each.val);
        // var u_s="";
        // if (10 <= u < 100) u_s = u.toFixed(2);
        // if (100 <= u < 1e3) u_s = u.toFixed(1);
        // if (1e3 < u) u = u_s.toFixed(0);
    }
