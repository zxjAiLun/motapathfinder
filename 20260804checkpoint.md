...
1. **PR-5.8f 已关闭；下一轮 5.8g Replay Performance P2**：在不丢失同-choice travel variants 的前提下缓存候选 apply/post-state，降低 strict replay attribution/verification 开销；必须保持 unique/no/multiple exact-post controls、真实 37/37 lineage、final exact state 与 outcome taxonomy，不得恢复 choice-level dedup。
